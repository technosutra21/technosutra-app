export const translations = {
  pt: {
    ...
    'map.gpsDeactivated': 'GPS Desativado',
    'map.gpsPermissionDenied': 'Permissão de localização negada',
    'map.gpsUnavailable': 'GPS indisponível - verifique sua conexão',
    'map.gpsTimeout': 'Timeout ao obter localização',
    'map.gpsAccuracy': 'Precisão',
    'map.nearbyWaypoints': 'pontos próximos',
    'map.routeCalculated': 'Rota calculada',
    'map.routeError': 'Erro ao calcular rota',
    'map.navigationStarted': 'Navegação iniciada',
    'map.navigationStopped': 'Navegação parada',
  ...
  en: {
    ...
    'map.gpsDeactivated': 'GPS Deactivated',
    'map.gpsPermissionDenied': 'Location permission denied',
    'map.gpsUnavailable': 'GPS unavailable - check your connection',
    'map.gpsTimeout': 'Timeout getting location',
    'map.gpsAccuracy': 'Accuracy',
    'map.nearbyWaypoints': 'nearby points',
    'map.routeCalculated': 'Route calculated',
    'map.routeError': 'Error calculating route',
    'map.navigationStarted': 'Navigation started',
    'map.navigationStopped': 'Navigation stopped',
